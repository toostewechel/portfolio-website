...
Thus, the ability to intentionally and strategically allocate our attention can be a competitive advantage in a distracted world, as time and attention are one of your most scarce and precious resources as a knowledge worker.
...
That is because, in general, good intentions only last for a short time, and only using willpower to achieve something is never enough as it is a limited resource that depletes quickly and does not improve significantly in the long term. On the other hand, not *'having willpower'* but *'not having to use willpower'* indicates that you set yourself up for success. But this is no easy feat because the more we are used to doing something in a particular way, the more in control we feel about it, even though we are often less in control of it _(mere-exposure effect)_. Besides, it is difficult to change behaviour in times of stress: the more pressure we feel, the more we tend to stick to our old routines, even when these routines cause problems and tension in the first place _(tunnel effect)_.
