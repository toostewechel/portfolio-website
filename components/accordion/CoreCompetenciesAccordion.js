...
export const AccordionTrigger = ({ children, avatarSrc, roleTitle, roleSubtitle, gradient, progressValue, helpText }) => (
    <HeaderPanel>
      <StyledHeaderTrigger >
       	<ContentContainer>
				...
				<ProgressBarContainer>
					<ProgressBar gradient={gradient} progressValue={progressValue} helpText={helpText} />
				</ProgressBarContainer>
      ...
      <AccordionItem value="item-1">
        ...
        <AccordionContent>
         		...
         		<ProductExecutionAccordion />
					...
					<QuoteLayout>
						<QuoteBlock quote="Wear the hat of a builder: define, build, and launch well-designed, stable products." cite="-- Execute flawlessly"/>
					</QuoteLayout>
        </AccordionContent>
      </AccordionItem>
