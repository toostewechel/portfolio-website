...
import { Database, BatteryCharging, Trees, Lightbulb, PersonStanding } from "lucide-react";
...
export default function CharacterTraitsAccordion() {
    ...
    <AccordionItem value="item-2">
      <AccordionTrigger hasIcon Icon={<BatteryCharging />}  title="Energy" src="/icons/hammer-line.svg" />
      <AccordionContent>
      	<CharacterTrait 
						labelLeft="Intuitive"
    ...
    <AccordionItem value="item-3">
      <AccordionTrigger hasIcon Icon={<Trees />}  title="Nature" src="/icons/smartphone.svg" />
      <AccordionContent>
       <CharacterTrait 
						labelLeft="Feeling"
						labelRight="Thinking"
    ...
    <AccordionItem value="item-4">
      <AccordionTrigger hasIcon Icon={<Lightbulb />}  title="Tactics" src="/icons/settings-line.svg" />
      <AccordionContent>
      	<CharacterTrait 
						labelLeft="Judging"
    ...
    <AccordionItem value="item-5">
      <AccordionTrigger hasIcon Icon={<PersonStanding />}  title="Identity" src="/icons/search-eye-line.svg" />
      <AccordionContent>
        <CharacterTrait 
						labelLeft="Assertive"
