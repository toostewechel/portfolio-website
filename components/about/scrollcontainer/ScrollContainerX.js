    ...
    <ScrollContainer ref={ref} >
      <CardContainer> 
        <CardInfo>
          ...
          <Paragraph>If someone ask me to do something I intend to keep my word</Paragraph>
        </CardInfo>
      </CardContainer>
      <CardContainer> 
        <CardInfo>
      ...
      <div>
          <button onClick={() => scroll(-360)}>Left</button>
          <button onClick={() => scroll(360)}>Right</button>
      </div>
    </div>
  );
}
