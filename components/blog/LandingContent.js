...
export default function LandingContent({ AvatarImage, AvatarLabel, AvatarDescription, HeadingTitle, Description, DatePosted}) {
	return (
		<LandingContentWrapper>
			<Avatar src={AvatarImage} name={AvatarLabel} description={AvatarDescription} />
			<Spacer level={8} />
			<FlexWrapper>
				<DecorativeIcon>
					<Calendar />
